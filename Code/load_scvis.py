...
import sys
sys.path.insert(0, "/home/kachau/Documents/ELDR/scvis/lib/scvis/")
sys.path.insert(0, "/home/kachau/Documents/ELDR/scvis/lib/")
...
def load_vae(input_dim, model_file, feature_transform = None):
    ...
    # Model Configuration
    try:
        config_file_yaml = open("/home/kachau/Documents/ELDR/scvis/lib/scvis/config/model_config.yaml", "r")
